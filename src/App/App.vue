...
<template>
  <div :class="{}">
    <div class="dark:bg-slate-900">
      <div
        class="mx-auto lg:p-8 p-2 dark:text-slate-200"
        style="max-width: 96ch"
      >
        ...
        <div class="font-sans">
          Single file microblogging using
          <a href="https://docs.markwhen.com" target="_blank" class="underline"
            >markwhen</a
          >.
        </div>
        <Example />
        <div class="flex flex-col gap-2 pb-16">
          ...
          <div class="">
            <ol>
              <li>
                1. Go to
                <a class="underline" href="https://markwhen.com"
                  >markwhen.com</a
                >
                and paste in the below text, or write your own.
              </li>
              <pre
                class="font-mono whitespace-pre text-sm rounded-lg bg-slate-100 p-2 my-1"
              >
re:
  title: My blog

May 25, 2023: hello!</pre
              >
              <li>
                2. Share the document ("Export & Share" -> "Share and get
                link"). You don't have to sign in.
              </li>
              <li>
                3. Your blog will show up in the list below (it may take a few
                seconds)
              </li>
            </ol>
          </div>
        ...
        <div class="flex flex-col gap-4">
          <div class="">Some blogs to check out:</div>
        </div>
      </div>
    </div>
  </div>
